...
pygame.display.set_caption("Crystals of Time by SmellyFrog - modified by GiovanniPython")
...
# The player image
spr_player = load("assets/player.png")
player_rect = spr_player.get_rect()

# The spheres rotating arounf the crystal
ball1 = load("assets/ball1.png")
ball2 = load("assets/ball2.png")

# All the tiles
spr_tiles = load("assets/tiles4.png")

spr_crystal1 = load("assets/crystal.png")
spr_crystal2 = load("assets/crystal2.png")
spr_particle = load("assets/particles.png")
spr_number = load("assets/number.png")
background = load("assets/bg2.png")
